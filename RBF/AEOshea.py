# Oshea's AE Implementation

from tensorflow.keras.layers import Dense, Input, Lambda, Concatenate, Reshape, BatchNormalization
...
#     self.model.compile( optimizer=tf.train.AdamOptimizer(learning_rate=0.01))
  ...
  def channel( self, faded_blk ):
    ...
    return faded_blk + np.sqrt(self.train_noisepow)*epsilon
